...
class Query extends CI_Controller 
{
	...
	public function index($keyword = 'null')
	{
		...
		$count = $this->M_query->countQueries($keyword,$filter);
		...
		$result["queries"] = $this->M_query->getQueries($start,$limit,$keyword,$filter);
		//$result["mainCategories"] = $this->M_category->getMainCategories();

		$result['pageHeading'] = 'Manage Queries';
		$result['startPage'] = $start;
				
		$this->load->view('v_header');
		$this->load->view('query/v_querylist',$result);
	...
	public function changeStatus()
	{
		...
		$result = $this->M_query->changeStatus($data);
		echo $result;
	}
