...
<table class="table table-bordered data" style="border:1px solid black; " cellpadding="2px" width="100%">
   <thead>
     <tr>
       <th width="5%"><b>Sno</b></th>
       <th width="39%"><b>Desciption of Goods</b></th>
       <th width="12%"><b>HSN/SAC</b></th>
       <th width="8%"><b>Quantity</b></th>     
       <th width="11%"><b>Rate</b></th>
       <th width="4%"><b>per</b></th>
       <th width="10%"><b>Disc.%</b></th>
      
       <th width="12.65%" style="text-align:right;"><b>Total Amount</b></th>
...
//<td width="20%" style="text-align:right;">Rs. '.$row['total_amount'].'</td>
    $totalProduct = $totalProduct+(($row['quantity']*$row['price_per_unit'])-$row['discount_amount']);
    ...
    $gstData['code'] = $hsnsac;
    $gstData['value'] = ($row['quantity']*$row['price_per_unit'])-$row['discount_amount'];
    ...
    $pdfContent.='<tr>
     <td width="5%">'.++$count.'</td>
       ...
       <td width="39%" style="background-color:#c2c2c2;">'.$row['product_name'].' </td>
       <td width="12%">'.$hsnsac.'</td>
       <td width="8%" style="text-align:center !important;">'.$row['quantity'].'</td>
       <td width="11%">Rs. '.round($row['price_per_unit']).'</td>
       <td width="4%">qty</td>';
      if($row['discount_amount']>0){
        $pdfContent.='<td width="10%">'.$row['discount_rate'].'%</td>';
      }else{
        $pdfContent.='<td width="10%"></td>';
      }
    $pdfContent.= '<td width="12.65%" style="text-align:right;">Rs. '.(($row['quantity']*$row['price_per_unit'])-$row['discount_amount']).'</td>
     </tr>';
    ...
    $pdfContent.='<tr valign="center">
      ...
      <td></td>
      <td></td>
      <td><b>'.$details['discount_amount'].'</b></td>
...
//<td width="20%" style="text-align:right;">Rs. '.$row['total_amount'].'</td>
    $totalProduct = $totalProduct+(($row['quantity']*$row['price_per_unit'])-$row['discount_amount']);
     $pdfContent.='<tr>
       ...
       <td width="21.65%" style="text-align:right;">Rs. '.(($row['quantity']*$row['price_per_unit'])-$row['discount_amount']).'</td>
     </tr>';
