...
class m_student extends CI_Model {
	...
	public function countStudents($keyword,$filter)
	{
		$this->db->select('*');
		$this->db->from('tbl_users');

		$this->db->where("(fname LIKE '%$keyword%' or email LIKE '%$keyword%' or mobile LIKE '%$keyword%') ");
	...
	public function getStudents($start,$limit,$keyword,$filter)
	{
