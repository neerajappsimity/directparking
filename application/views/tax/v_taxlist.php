...
<div class="table_data" aria-labelledby="headingOne" role="tabpanel" id="chat">
	...
	<div class="portlet box grey">
						...
						<a href="<?php echo site_url(); ?>tax/viewTax?tid=<?php echo base64_encode($row['id']); ?>" class="btn default green"><i class="fa fa-eye"></i> View</a>&nbsp;
...
alert('Your search string contains illegal characters.');
 ...
 window.location.href = window.location.href='<?php echo base_url().'tax/index/'; ?>' + $('#searchFORMHEAD_input').val()+ '<?php echo '?'.$_SERVER['QUERY_STRING'];?>';
