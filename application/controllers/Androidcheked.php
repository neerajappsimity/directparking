...
/************** End FCM Code***************************/
	...
	*/
	...
	public function checkReview()
	{
		...
		$ridecheck = $this->M_android->checkRide($user_id);
		echo json_encode($ridecheck);
