						...
						<div class="portlet">
							...
							<div class="form-body">
									...
									<div class="form-group">
													...
													<div class="col-md-4">
														<select class="table-group-action-input form-control input-medium" name="category_id" id="category_id" onchange="getSubcategories(this.value);">
															<option value="">Select...</option>
													...
													<div class="col-md-4">
														<select class="table-group-action-input form-control input-medium" name="sub_id" id="sub_id" onchange="getProducts(this.value);" >
															<option value="">Select...</option>
									...
									<div class="form-group">
													<label class="col-md-2 control-label">Products:
													
													</label>
													<div class="col-md-4">
														<select class="table-group-action-input form-control input-medium" name="product_id" id="product_id" >
...
function getProducts(id)
{
	var form_data = "id="+id;
	$.ajax({
		url: URL +"product/getProductsOnSub", 
		type: "post", 
		data: form_data,
		dataType: 'json',
		...
		{
			var htmlStr = '';
			htmlStr ='<option value="">Choose Subcategory</option>';
    $.each(results, function(k, v){
        htmlStr += '<option value='+v.id + '> ' + v.name + '</option>';
   });
			$('#product_id').html(htmlStr);
