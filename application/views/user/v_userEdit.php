						...
						<div class="portlet">
							<div class="portlet-title">
								...
								<div class="actions btn-set">
									...
									<button class="btn green"><i class="fa fa-check"></i> Update</button>
							...
							<div class="form-body">
									...
									<div class="form-group">
											...
											<div class="col-md-4">
											<input type="text" class="form-control" id="domain" value="<?php echo ucfirst($userData['domain']); ?>" name="domain" placeholder="Eg: www.universityname.edu/.com/.in ">
