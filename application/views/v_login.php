...
<!-- END LOGO -->
	...
	<form onsubmit="return login()" action="javascript:void(0)">
		...
		<?php $id=base64_encode(1); $siteUrl=site_url();?>
		<div class="forget-password">
			<h4>Forgot your password?</h4>
			<p>
				 no worries, click
				<!-- <a href="<?php echo site_url(); ?>Welcome/adminForgetPassword/?token='.$id.'" id="forget-password"> -->
					<?php echo "<a href='$siteUrl/Welcome/adminForgetPassword/?token=$id'>"; ?>
					 here
				</a>
