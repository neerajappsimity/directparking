										...
										<!--div class="row">
											<div class="col-md-12 col-sm-12">
												<div class="portlet red box">
													...
													<div class="row">
															<div class="col-md-2">
																<input type="button" onclick="javascript:addRefund();" class="btn btn-danger" value="Add Refund">
															</div>
															<div class="col-md-10">
													...
													<div class="table-responsive">
															...
															<tr>
																	...
																	<td align="right">
																		Rs. <?php echo $refund['amount'];?>
																	</td>
																	<td align="right">
																		<?php echo $refund['txn_date'];?>
																	</td>
																	<td align="right">
...
function addRefund()
{
	...
	$.ajax({
		...
		{
			$('#message').html('');
			if(htmlStr == 'TXN_SUCCESS')
			{
				$('#message').html('<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Success!</strong> Amount refunded.</div>');

				window.setTimeout(function(){window.history.back();}, 1500);
				
			}else if(htmlStr == 'PENDING')
			{
				$('#message').html('<div class="alert alert-warning"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> Refund process is pending.</div>');
				
			}
			else
			{
				
				$('#message').html('<div class="alert alert-danger"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Alert!</strong> Refund process failed.</div>');
