...
class Student extends CI_Controller 
{
	...
	public function index($keyword = 'null')
	{
		...
		$config['base_url'] = base_url().'student/index/' . $keywordDuplicate . '/';
		
		$count = $this->M_student->countStudents($keyword,$filter=null);
		...
		$result["users"] = $this->M_student->getStudents($start,$limit,$keyword,$filter=null);	
		//echo "<pre>";
		//print_r($result["users"]);	
		//echo "</pre>";
		$result['pageHeading'] = 'Manage Students';
		$result['startPage'] = $start;
		$result['pageFunction'] = 'index';
				
		$this->load->view('v_header');
		$this->load->view('student/v_studentlist',$result);
		$this->load->view('v_footer');
	}

	public function exportData()
		{
			$students = $this->M_student->getStudents($start=null,$limit=null,$keyword=null,$filter=null);
	...
	public function changeVerified()
	{
		$data = $_POST;
		//print_r($data);
		$check = $this->M_student->checkVerified($data);
		...
		$result = $this->M_student->changeVerified($data);
		echo $result;
	}
