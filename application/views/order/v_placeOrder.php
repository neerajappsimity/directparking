										...
										<form id="addProduct">
											...
											<div class="row searchHide">
													<div class="col-md-12">
															...
															<input type="text" class="col-md-12 form-control txt-auto" id="proDiscount" name="proDiscount">
													</div>
											</div>
											<!--div class="row searchHide">
													<div class="col-md-12">
					...
					<form class="form-horizontal form-row-seperated" id="addOrderForm" method='post' enctype="multipart/form-data" action="javascript:placeOrder();">
						...
						<div style="float:right; margin-bottom:2%;">
							...
							<tr>
								...
								<th ><input class="totalAmount form-control" name="total_amount" readonly="" value="0">
								<input class="totalDisAmount form-control" type="hidden" name="total_dis_amount" readonly="" value="0"></th>
								<th></th>
							</tr>
							<tr>
