						...
						<div class="portlet">
							...
							<div class="form-body">
									...
									<div class="form-group">
											...
											<div class="col-md-4">
											<input type="text" class="form-control" id="name"  name="name" placeholder="eg: Stanford">
											
											</div>
											<label class="col-md-2 control-label">Domain:
											</label>
											<!-- <div class="col-md-4">
											<input type="url" class="form-control" id="email" name="email" placeholder="email " required>
											</div> -->
											<div class="col-md-4">
											<input type="url" class="form-control" id="domain" name="domain" placeholder="Eg: www.universityname.edu/.com/.in " required>
											</div>
									</div>
									<!-- <div class="form-group">
...
<!-- 
									...
									<div class="form-group">
										<label class="col-md-2 control-label">University Status: </label>
										<input type="radio" name="enabled" checked="checked"  value="Y" > Enabled 
										<input type="radio" name="enabled" value="N" > Disabled
									</div>

									<div class="form-group">
										<label class="col-md-2 control-label">University Verification Status: </label>
...
function addUser()
{
	...
	/*else if(mobile == ""){
		...
		success: function (htmlStr)
		{
			...
			if(htmlStr == 'false')
			{
				$('#message').html('<div class="alert alert-danger"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Danger!</strong> University could not be added.</div>');
			}
			else
			{
				$('#message').html('<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Success!</strong> University added successfully.</div>');
