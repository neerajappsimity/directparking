...
<link href="<?php echo site_url(); ?>assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo site_url(); ?>assets/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo site_url(); ?>assets/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo site_url(); ?>assets/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo site_url(); ?>assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css"/>
...
<link href="<?php echo site_url(); ?>assets/css/pages/tasks.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo site_url(); ?>assets/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
<link href="<?php echo site_url(); ?>assets/css/print.css" rel="stylesheet" type="text/css" media="print"/>
...
<div class="header navbar navbar-fixed-top">
	...
	<div class="header-inner">
		...
		<a class="navbar-brand" href="<?php echo site_url(); ?>">
			<img src="<?php echo site_url(); ?>assets/img/logo.png" width="80px" alt="logo" class="img-responsive" style="margin-top: -15px;margin-left: 55px;"/>
		</a>
		<!-- END LOGO -->
		...
		<ul class="nav navbar-nav pull-right">
			...
			<li class="dropdown" id="header_notification_bar">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					...
					<span class="badge notiCount" id="notiBell" style="display:none;" >
				...
				<ul class="dropdown-menu extended notification">
					<li id="notiRow" >
						<p>
							 You have <span class="notiCount">no</span> new notifications.
						</p>
					</li>
					<li>
						<ul class="dropdown-menu-list scroller" id="notificationListId" style="height: 250px;">
							<!--li>
								<a href="#">
			...
			<li class="dropdown user">
				...
				<ul class="dropdown-menu">
					<li>
						<a href="<?php echo site_url(); ?>welcome/editProfile">
					...
					<li>
						<a href="javascript:void(0)" onclick="logout()"><i class="fa fa-key"></i> Log Out</a>
					</li>
				</ul>
			</li>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<?php if($_SESSION['user_type'] == 1){?>
					...
					<li class="<?php if($this->uri->segment(1) == 'content'){ echo "active"; } ?>">
					<a href="javascript:;">
					...
					<ul class="sub-menu">
						<li>
							<a href="<?php echo site_url(); ?>ride/index">
								<i class="fa fa-car"></i>
								View Rides
							</a>
						</li>
				...
				<!-- <li class="<?php if($this->uri->segment(1) == 'content'){ echo "active"; } ?>">
					...
					<ul class="sub-menu">
						<li>
							<a href="<?php echo site_url(); ?>content/banners">
								<i class="fa fa-flag"></i>
								Banner
							</a>
						</li>
