	...
	public function userLogin()
	{
		...
		}else if($result['enabled'] == 'Y')
		{
			...
			if(!empty($result['gst'])){
				...
				$resultLogin= array('success'=>'1','user_id'=>$result['id'],'user_type'=>$result['user_type_id'], 'first_name'=>$result['fname'],'last_name'=>$result['lname'],'email'=>$result['email'],'mobile'=>$result['mobile'],'tax_type_id'=>'4','tax_name'=>'VAT','tax_rate'=>'14.5','is_pass_changed'=>$result['is_pass_changed'],'gst'=>$result['gst']);
