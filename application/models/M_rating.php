...
class m_rating extends CI_Model {
	...
	public function getRating($start,$limit,$keyword,$filter)
	{

		$this->db->select('R.id as id,R.user_id,R.related_id,R.comment,R.is_verified,U.id,U.fname,U.email,U.mobile,U.university_id,UV.name as university_name');
		...
		$this->db->where("(U.fname LIKE '%$keyword%' or U.email LIKE '%$keyword%' or U.mobile LIKE '%$keyword%' or R.rating LIKE '%$keyword%') ");
...
/*	public function getFirm()
	...
	{
		//print_r($id);die;
		$this->db->select('U.*, UV.name as university');
		$this->db->from('tbl_users as U');
		...
		public function getRatingData($id)
	{
		...
		public function getUserRatingData($id)
	{
		//print_r($id);die;
		$this->db->select('R.*,U.id as uid,U.fname as user_name,U.email as email,U.mobile');
		$this->db->from('review_rating as R');
		$this->db->join('tbl_users as U','U.id = R.related_id','left');
